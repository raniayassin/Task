...
public class SignupWithInvalidFirstAndLastName extends TestBase{
	...
	@Test(priority = 1)
	public void signupWithInvalidFirstAndLastName()
	{
		...
		// First and last name are start with small letters
		signupObject.setFirstName(firstName.toLowerCase());
		signupObject.setLastName(lastName.toLowerCase());
		
		signupObject.setPhone(phone);
		signupObject.setEmail("a"+email);
